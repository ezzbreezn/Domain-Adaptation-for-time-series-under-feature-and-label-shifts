...
class Boiler(object):
    def __init__(self):
        ...
        self.num_classes = 2
        self.sequence_len = 36
        self.shuffle = True
        self.drop_last = True
        self.normalize = True
        self.fourier_modes = 4
...
class FutureCrop():
    def __init__(self):
        super(FutureCrop, self)
        # TODO: Check the pairs randomness
        self.scenarios = [("2", "11"), ("6", "23"),("7", "13"),("9", "18"),("12", "16"),\
            ("13", "19"),  ("18", "21"), ("20", "6"),("23", "13"),("24", "12")]
        self.class_names = ['1', '2', '3', '4', '5', '6', '7']
        self.sequence_len = 240
        self.shuffle = False
        self.drop_last = True
        self.normalize = True

        # model configs
        self.input_channels = 9 # 6 for weather features and 3 for soil ones
        self.kernel_size = 5
        self.stride = 1
        self.dropout = 0.5
        self.num_classes = 7
        ...
        assert len(self.class_names) == self.num_classes, "Check class implemetation!"
        # CNN and RESNET features
